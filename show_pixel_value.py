...
def mouse_event(event,x,y,flg,param):
    ...
    if event == cv2.EVENT_RBUTTONDOWN:#in single click it will provide a data
        b = img[y,x,0]#for blue channel is 0,it will give blue value of pixel
        g =img[y,x,1]#for green channel is 1,it will give green value of pixel
        r = img[y,x,2]#for red channel is 2,it will give red value of pixel
